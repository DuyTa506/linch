...
See :mod:`agent_kit.filesystem.backend` for the backend protocol and
implementations, :mod:`agent_kit.filesystem.offload` for the auto-offload
mechanism, and :mod:`agent_kit.filesystem.tools` for the ls/read_file/
