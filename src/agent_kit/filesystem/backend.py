...
the real disk — built-in :class:`~agent_kit.tools.builtin.ReadTool` etc. already
...
Persistent backends (see :mod:`agent_kit.filesystem.sqlite`) implement the same
...
def _slice_lines(text: str, offset: int, limit: int | None) -> str:
    ...
    Mirrors the semantics of :class:`~agent_kit.tools.builtin.ReadTool`: an
