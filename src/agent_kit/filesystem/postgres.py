"""PostgreSQL-backed :class:`~agent_kit.filesystem.backend.FileBackend`.

Use instead of :class:`~agent_kit.filesystem.backend.SqliteFileBackend` when
...
Usage::
    ...
    from agent_kit.filesystem import OffloadConfig
...
class PostgresFileBackend:
    ...
    All six :class:`~agent_kit.filesystem.backend.FileBackend` methods are
