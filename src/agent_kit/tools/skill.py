...
class SkillTool:
    ...
    async def execute(self, input: dict[str, Any], ctx: ToolContext) -> ToolResult:
        from agent_kit.skills.overlay import resolve_model_override
        from agent_kit.skills.substitute import substitute_skill_body
        from agent_kit.types import InvokedSkillRecord, SkillOverlay
