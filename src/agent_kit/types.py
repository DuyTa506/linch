...
class OutputSchema:
    ...
    When set on :class:`ProviderRequest`, :class:`~agent_kit.session.RunOptions`,
    or :class:`~agent_kit.agent.Agent`, the provider will constrain its
    response to this JSON Schema.  The parsed result surfaces as
    :attr:`~agent_kit.events.ResultEvent.structured_output`.
