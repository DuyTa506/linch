...
Exercises: ``final_tool_name``, :class:`~linch.types.OutputSchema`,
``deps``, tool-aware system prompt.

Quick start::

    import sqlite3
    from linch.recipes.text_to_sql import sql_agent, SqlDeps
...
def sql_agent(
    ...
    **agent_kwargs: Any,
    ...
    Returns:
        An :class:`~linch.agent.Agent` that terminates on the
